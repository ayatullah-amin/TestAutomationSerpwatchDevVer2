...
WebUI.waitForElementPresent(findTestObject('CreateNewProject/FormPage_1/input_domain_name'), GlobalVariable.Timeout)
...
WebUI.focus(findTestObject('CreateNewProject/FormPage_1/input_project_name'))
