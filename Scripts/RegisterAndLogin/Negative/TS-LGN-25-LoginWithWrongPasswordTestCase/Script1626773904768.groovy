...
WebUI.setText(findTestObject('LoginPage/input_sign in_email'), GlobalVariable.LoginUsername)

WebUI.setText(findTestObject('LoginPage/input_sign in_password'), 'abc')
