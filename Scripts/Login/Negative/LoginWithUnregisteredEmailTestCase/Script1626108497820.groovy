...
WebUI.setText(findTestObject('LoginPage_SerpWatch/input_sign in_email'), 'aaa@gmail.com')

WebUI.setText(findTestObject('LoginPage_SerpWatch/input_sign in_password'), 'abc')
