...
WebUI.setText(findTestObject('RegisterPage/input_signup_name'), 'aaa')

WebUI.setText(findTestObject('RegisterPage/input_signup_email'), '')

WebUI.setText(findTestObject('RegisterPage/input_signup_password'), 'aaaaaa')
